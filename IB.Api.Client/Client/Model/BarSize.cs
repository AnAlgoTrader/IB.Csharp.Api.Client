namespace IB.Api.Client.Client.Model
{
    public class BarSize
    {
        ...
        public const string TwoMinutes = "2 min";
        public const string ThreeMinutes = "3 min";
        public const string FiveMinutes = "5 min";
        public const string TenMinutes = "10 min";
        public const string FifteenMinutes = "15 min";
        public const string TwentyMinutes = "20 min";
        public const string ThirtyMinutes = "30 min";
